...
- Sternschema und Bridge-Tabellen (n:m) in Power BI
- Aufbereitung in Power Query, Kennzahlen in DAX
- KPI-Dashboards aus Fachdaten (Wirtschaft, Finanzen, Reporting) mit klarer Quellenangabe
...
![KPI-Dashboard Energiewende](ziel-ergebnisse.png)

📍**[Olympische Spiele — Datenanalyse (Power BI)](https://github.com/sinienko-inna/olympische-spiele-powerbi)**  
Sternschema, SQL/PostgreSQL (Abfragen und Modell), DAX (u. a. Länderranking).

## Kontakt

- LinkedIn: [inna-sinienko](https://www.linkedin.com/in/inna-sinienko)
- GitHub: sinienko-inna
